...
- [HODOS + CASEFLOW](https://hodos.app) - **[AI-Native]** Bilingual (EN/ES) legal AI platform with per-firm multi-tenant isolation enforced by RLS-in-CI. Practice areas: immigration, PI, workers' comp, family. North Carolina jurisdictional depth (NC scaffolds across 4 verticals with county variance). 14 AI agents with layered prompt-injection defense, LEDES bill drafting, 101 USCIS/court form scaffolds with daily edition-change watcher, Retell + LiveKit voice intake. Production scale: 27,513-matter Clio mirror in ~21 hours. Anchor: Vasquez Law Firm (NC, 30+ years).
